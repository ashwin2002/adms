...
class Gstr2bHeaders(object):
    ...
    input_header["B2BA"] = [
        ...
        B2BA.RCM, B2BA.RATE, B2BA.TAXABLE, B2BA.IGST_PAID, B2BA.CGST_PAID,
        B2BA.SGST_PAID, B2BA.CESS_PAID, B2BA.GST1_YRM, B2BA.GSTR1_FILED_DATE,
    ...
    input_header["CDNR"] = [
        ...
        CDNR.RATE, CDNR.TAXABLE, CDNR.IGST_PAID, CDNR.CGST_PAID,
        CDNR.SGST_PAID, CDNR.CESS_PAID, CDNR.GST1_YRM, CDNR.GSTR1_FILED_DATE,
    ...
    input_header["CDNRA"] = [
        ...
        CDNRA.RATE, CDNRA.TAXABLE, CDNRA.IGST_PAID, CDNRA.CGST_PAID,
        CDNRA.SGST_PAID, CDNRA.CESS_PAID, CDNRA.GST1_YRM,
        CDNRA.GSTR1_FILED_DATE, CDNRA.SUBMITTED, CDNRA.REASON,
