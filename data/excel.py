...
class HeadersJul2020Current(HeadersTillJun2020):
    ...
    input_header["TCS"] = [
        TCS.SUPP_NAME, TCS.GST2_YRM, TCS.INV_VALUE, TCS.TAXABLE,
        TCS.TCS_NET, TCS.IGST_PAID, TCS.CGST_PAID, TCS.SGST_PAID]

    input_header["IMPG"] = [
        IMPG.INV_DATE, IMPG.PORT_CODE, IMPG.INV_NO, IMPG.INV_DATE,
