...
class ExcelHeaders(object):
    ...
    input_header["B2BA"] = [
        Gstr2.DUPLICATE, Gstr2.DUPLICATE, B2BA.GSTIN, B2BA.SUPP_NAME,
    ...
    input_header["CDNR"] = [
        CDNR.GSTIN, CDNR.SUPP_NAME, CDNR.INV_TYPE, CDNR.INV_NO, CDNR.INV_DATE,
        CDNR.INV_VALUE, CDNR.REASON, CDNR.RATE, CDNR.TAXABLE, CDNR.IGST_PAID,
        CDNR.CGST_PAID, CDNR.SGST_PAID, CDNR.CESS_PAID, CDNR.SUBMITTED]
